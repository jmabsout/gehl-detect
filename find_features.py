...
# imageDir = '/Users/marioag/Dropbox (Personal)/documents/mit-github-projects/gehl/Gehl/img'
images = []
...
for each in images:
    ...
    (rects, weights) = hog.detectMultiScale(image, winStride=(4, 4), padding=(3, 3), scale=1.5)# 4,4; 2,2; 1.5
    ...
    cv2.imwrite("/Users/marioag/Documents/GitHub/gehl-detect/out/find_features/outside/padding33/image{}.png".format(j), image)
    j += 1