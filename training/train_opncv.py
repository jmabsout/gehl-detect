...
POSITIVE_SAMPLE_IMAGE_PATH = 'INRIAPerson2/Train/pos/'
NEGATIVE_SAMPLE_IMAGE_PATH = 'INRIAPerson2/Train/neg/'
...
def load_sample_image(sign):
    ...
    if sign == SIGN_POSITIVE:
        print "loading positive image..."
        path = POSITIVE_SAMPLE_IMAGE_PATH
    elif sign == SIGN_NEGATIVE:
        print "loading negative image..."
